  ...
  return (
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div id="map" className="mt-12 grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.25em] text-river">Plan a ride</p>
            <h2 className="mt-3 font-display text-4xl font-black text-pine sm:text-5xl">Trail links and access</h2>
            <p className="mt-5 text-lg leading-8 text-ink/72">
              Muscogee is a public trail system near Pensacola with community-built singletrack and ongoing expansion work. Use the links below for current maps, group updates, and PORC information.
            </p>
          </div>
